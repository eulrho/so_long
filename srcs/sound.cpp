...
void Game::stopSound()
{
	BASS_ChannelStop(this->backgroundHandle);
	BASS_StreamFree(this->backgroundHandle);
	BASS_StreamFree(this->walkHandle);
	BASS_StreamFree(this->mouseHandle);
	BASS_StreamFree(this->exitHandle);
}